...
CGameDoc::CGameDoc()
{
	// FRAMEWORK_TODO: add one-time construction code here
...
BOOL CGameDoc::OnNewDocument()
{
	...
	// FRAMEWORK_TODO: add reinitialization code here
...
void CGameDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
		// FRAMEWORK_TODO: add storing code here
	}
	else
	{
		// FRAMEWORK_TODO: add loading code here
	}
}
