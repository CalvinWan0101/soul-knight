...
Stage_1_5::Stage_1_5() {
    ...
    MonsterRoom* room2 = new MonsterRoom(Point(688, 592), centerOffset, RoomSize::MEDIUM_SIZE, 4, 1);
    MonsterRoom* room4 = new MonsterRoom(Point(48, 1232), centerOffset, RoomSize::MEDIUM_SIZE, 4, 1);
    MonsterRoom* room5 = new MonsterRoom(Point(640, 1184), centerOffset, RoomSize::LARGE_SIZE, 4, 1);
    MonsterRoom* room6 = new MonsterRoom(Point(1328, 1232), centerOffset, RoomSize::MEDIUM_SIZE, 4, 1);
