...
Stage_1_4::Stage_1_4() {
    ...
    MonsterRoom* room1 = new MonsterRoom(Point(640, 688), centerOffset, RoomSize::MEDIUM_SIZE, 4, 1);
    ...
    MonsterRoom* room5 = new MonsterRoom(Point(640, 1968), centerOffset, RoomSize::MEDIUM_SIZE, 4, 1);
