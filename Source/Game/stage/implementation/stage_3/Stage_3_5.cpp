...
Stage_3_5::Stage_3_5() {
    ...
    MonsterRoom* room2 = new MonsterRoom(Point(1840, 80), centerOffset, RoomSize::MEDIUM_SIZE, 4, 3);
    MonsterRoom* room3 = new MonsterRoom(Point(0, 640), centerOffset, RoomSize::MEDIUM_SIZE, 4, 3);
    MonsterRoom* room4 = new MonsterRoom(Point(592, 592), centerOffset, RoomSize::LARGE_SIZE, 4, 3);
    MonsterRoom* room5 = new MonsterRoom(Point(1280, 640), centerOffset, RoomSize::MEDIUM_SIZE, 4, 3);
    MonsterRoom* room6 = new MonsterRoom(Point(1872, 672), centerOffset, RoomSize::SMALL_SIZE, 4, 3);
    MonsterRoom* room7 = new MonsterRoom(Point(1792, 1200), centerOffset, RoomSize::LARGE_SIZE, 4,
                                         std::map<MonsterType, int>{{MonsterType::ZULAN, 1}}, true);
    ...
    monsterRooms.push_back(room7);

    treasureRoom = new TreasureRoom(Point(1312, 112), centerOffset);
